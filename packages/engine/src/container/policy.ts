...
// Huabu-main/packages/shared/src/canvas-engine/container/policy.ts.

import type { Node } from "@xyflow/react";

/** Return whether a node may own persistent children. Frames are the persistent Container type. */
