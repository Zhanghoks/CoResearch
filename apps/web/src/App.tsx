...
import { NodeIntroPage } from './components/Home/NodeIntroPage'
...
/** Which canvas node each node type maps to in the current project — used by NodeIntroPage's "view in canvas". */
